...
<html>
    <head>
        ...
        <title>Registration - Skill Sphere</title>
            ...
            <div class="card rounded-2" style="width: 22rem; margin: 0px auto; margin-top: 4rem; background-color: #ECE6F6">
                <form action="regcode.jsp" method="post">    
                    <div class="row p-2">
                        ...
                        <h5 class="text-center text-black mt-1">Sign Up</h5>
                        <div class="mt-2 col-sm-12 text-start">
                            <h6 class="ms-4 text-dark">Full Name </h6>
                        ...
                        <div class="mt-2 col-sm-12 text-start">
                            <h6 class="ms-4 text-dark">Email </h6>
                        ...
                        <div class="mt-3 col-sm-12">
                            <h6 class="ms-4 text-dark">Password </h6>
                        ...
                        <div class="col-sm-12 mt-3 text-center">
                            <button type="submit" class="btn text-light" style="background-color: #990099">Sign Up</button>
                        </div>
                        ...
                        <div class="col-sm-12 mt-2">
                            ...
                            <p class="text-center text-dark">Already have an account? <a href="login.jsp" style="color: #990099">Log In</a></p>
                        </div>
                        <div class="col-sm-12 mt-2 text-center">
                            <p style="font-size: 10px">I accept Skill Sphere <a href="#" style="color: #990099">Terms of Use</a> and <a href="#" style="color: #990099">Privacy Notice</a> <br> Having trouble logging in? <a href="#" style="color: #990099">Learner help center</a> </p>
                        </div>
                    </div>
                </form>
            </div>
